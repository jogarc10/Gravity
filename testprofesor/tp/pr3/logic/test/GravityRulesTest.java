...
public class GravityRulesTest {
	...
	protected GameRules getReglas() {
		return new GravityRules(20,10);
	}

	@Test
	public void testIniciaTablero() {
		Board t = r.newBoard();
		assertEquals("The board does not have the appropriate width", 20, t.getWidth());
		assertEquals("The board does not have the appropriate height", 10, t.getHeight());
